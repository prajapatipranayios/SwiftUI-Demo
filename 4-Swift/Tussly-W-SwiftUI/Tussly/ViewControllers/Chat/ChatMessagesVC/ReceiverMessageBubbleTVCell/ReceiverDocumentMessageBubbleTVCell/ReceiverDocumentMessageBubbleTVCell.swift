//
//  ReceiverDocumentMessageBubbleTVCell.swift
//  Tussly
//
...
class ReceiverDocumentMessageBubbleTVCell: UITableViewCell {
    ...
    @IBOutlet weak var ivImage: UIImageView! {
        didSet {
            self.ivImage.layer.cornerRadius = self.ivImage.frame.width / 2
            self.ivImage.tintColor = .white
        }
    }
    ...
    override func awakeFromNib() {
        ...
        DispatchQueue.main.async {
            //self.constraintHeightIvImage.constant = self.contentView.frame.width * 0.50
        }
    }
