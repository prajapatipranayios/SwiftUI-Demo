...
class SenderImageMessageBubbleTVCell: UITableViewCell {
    ...
    @IBOutlet weak var constraintBottomIvImageToLblTime: NSLayoutConstraint!
    @IBOutlet weak var constraintTrailIvImageToSuper: NSLayoutConstraint!
    ...
    @IBOutlet weak var constraintWidthIvImage: NSLayoutConstraint!
    ...
    override func layoutSubviews() {
        ...
        self.constraintWidthIvImage.constant = self.contentView.frame.width * 0.50
    }
    
    override func prepareForReuse() {
        super.prepareForReuse()
        ivImage.image = nil
        // Reset any layout-affecting flags or constraints if needed
    }
