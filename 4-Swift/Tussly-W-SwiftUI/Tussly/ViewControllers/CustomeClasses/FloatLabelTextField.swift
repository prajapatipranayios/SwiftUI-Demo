...
@IBDesignable class FloatLabelTextField: UITextField {
    ...
    @IBInspectable var leftImgView: UIImage? {
        didSet {
            let mainView = UIView(frame: CGRect(x: 0, y: 8, width: self.frame.size.height - 8, height: self.frame.size.height - 8))
            
            let view = UIView(frame: CGRect(x: 0, y: 0, width: self.frame.size.height - 8, height: self.frame.size.height - 8))
    ...
    @IBInspectable var rightImgView: UIImage? {
        didSet {
