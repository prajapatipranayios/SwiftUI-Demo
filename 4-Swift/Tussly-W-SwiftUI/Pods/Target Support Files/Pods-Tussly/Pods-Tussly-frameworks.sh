...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CometChatSDK/CometChatSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CometChatSDK/CometChatStarscream.framework"
fi
